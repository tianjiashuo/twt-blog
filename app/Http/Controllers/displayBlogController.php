...
class displayBlogController extends Controller
{
    ...
    public function displayBlog($mid)
    {
        ...
        //var_dump($Time);
        //var_dump($Blogs);
        return view('displayBlog',['Blogs'=> $Blogs,'Time' => $Time,'Content' => $Content,'Author' => $Author,'CommentContent' => $CommentContent,'CommentUsername' => $CommentUsername,'CommentTime' => $CommentTime,'CommentID' => $CommentID]);
    }
}
